        ...
        <div class="flex h-screen bg-background">
          ...
          <div class="relative flex flex-1 items-center justify-center bg-background px-4">
            ...
            <div class="flex w-full max-w-105 flex-col gap-6 rounded-xl border border-border bg-card p-6 shadow-md md:p-8">
              <div class="text-left">
                <h1 class="mb-2 text-2xl font-bold text-foreground">Entrar na sua conta</h1>
              ...
              <form class="flex flex-col gap-4" onSubmit={handleSubmit}>
                ...
                <div class="relative">
                  <a href="#" class="absolute right-0 top-0 text-xs font-semibold text-primary hover:underline">
                    Esqueceu a senha?
                  </a>
                  <Input
                      labelText="Senha"
                ...
                {errorMessage() && <p class="text-sm text-error">{errorMessage()}</p>}
