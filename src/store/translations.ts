    ...
    PT: {
        ...
        teamSchedule: {
            ...
            pending: {
                ...
                reject: "✕ Recusar",
                confirmReject: "Deseja realmente recusar este agendamento?",
            ...
            blocks: {
                ...
                confirmDelete: "Deseja realmente apagar este bloqueio?",
    ...
    EN: {
        ...
        teamSchedule: {
            ...
            pending: {
                ...
                reject: "✕ Reject",
                confirmReject: "Do you really want to reject this appointment?",
                proposalSent: (date: string, time: string) =>
            ...
            blocks: {
                ...
                confirmDelete: "Do you really want to delete this block?",
